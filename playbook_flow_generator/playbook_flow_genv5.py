...
"""
Autogenerated playbook(red team)
"""
#suspected_crimetype = "data_theft"
suspected_crimetype = "unauthrised_access"
overall_workflow = []

if suspected_crimetype == "data_theft":
    datatheftlist = getTtpList('Exfiltration')
    for ttpid in datatheftlist:
        try:
            flowlist = generateFlow(graph, ttpid)
            overall_workflow.append((ttpid, flowlist))
        except Exception as e:
            print(e)

if suspected_crimetype == "unauthrised_access":
    datatheftlist = getTtpList('Credential Access')
    for ttpid in datatheftlist:
        try:
            flowlist = generateFlow(graph, ttpid)
            overall_workflow.append((ttpid, flowlist))
...
pprint(overall_workflow)

"""
TTP based playbook(blue team)
"""
