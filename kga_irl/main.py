...
# to convert and generate json object from networkx graph
graphs = [g for x, y, g in train_sample]
for G in graphs[:1]:
    nx.set_edge_attributes(G, values="test_attributes_val",
                           name='test_attributes_key')
